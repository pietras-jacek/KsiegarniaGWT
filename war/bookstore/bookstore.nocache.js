...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "bookstore" because\n';
  ...
  $wnd.__gwt_activeModules['bookstore'] = {
 ...
 * "/bookstore.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['bookstore'].superdevmode = true;

  var expectedSuffix = '/bookstore.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + bookstore + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:bookstore';
  var devModeSessionKey = '__gwtDevModeSession:bookstore';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/bookstore/bookstore.nocache.js';
  ...
  $wnd.__gwt_activeModules['bookstore'].canRedirect = true;
  $wnd.__gwt_activeModules['bookstore'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/bookstore?user.agent=' + ua + '&_callback=' + callback;
